...
const DVD_TITLES = [
  ...
  ['PERISH HARDER', 'a rental store sleeve inside', 'dieharderish'],
...
const COMIC_TITLES = [
  ...
  ['SPECTACULAR WEB-GUY #{n}{n2}', 'the clone one. do not ask which clone', 'cx_spiderguy'],
  ['IRONY MAN #{n}{n2}', 'the armor changes every cover. it never mattered', 'cx_ironyman'],
  ['THORAX #{n}{n2}', 'speaks in fake old english the whole issue', 'cx_thorr'],
  ...
  ['GHOST BIKER #{n}{n2}', 'flaming skull, tasteful flames', 'cx_ghostridder'],
  ...
  ['THE LATE SHIFT RETURNS #{n}', 'the gritty one. every copy is somebody\'s favorite', 'cx_darknight'],
];
const COMIC_KEEPERS = [
